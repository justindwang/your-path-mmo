...
function renderStats(){
  ...
  for(var i = 0; i< playerList.length; i++){
      ...
      html += '<div class="menu-item" id="stats-item-'+ i + '"><div class="menu-item-icon">' + icon + '</div><div class="menu-item-info"><h4>' + playerList[i].name + '</span> <br> <span style="color: #ffffff33;">' + playerList[i].job + ' - Lvl ​' + playerList[i].level + '</span></h4></div></div>';
  }
  statsBody.innerHTML = html;
}
